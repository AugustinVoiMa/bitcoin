...
* pizcoin.conf: contains configuration settings for pizcoind or pizcoin-qt
* pizcoind.pid: stores the process id of pizcoind while running
...
* debug.log: contains debug information and general logging generated by pizcoind or pizcoin-qt
