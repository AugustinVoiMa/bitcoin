...
This document provides guidelines for internationalization of the Pizcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pizcoin_en.ts` remains unchanged.
