Pizcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pizcoin/files/Pizcoin/pizcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pizcoin
...
New/changed settings (command-line or pizcoin.conf file)
--------------------------------------------------------
