Pizcoin Core version 0.10.4 is now available from:

  <https://pizcoin.org/bin/pizcoin-core-0.10.4/>
...
- #6953 `43c2789` Split pizcoin-tx into its own package
- #6953 `dfe0d4d` Include pizcoin-tx binary on Debian/Ubuntu
