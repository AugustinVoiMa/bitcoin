Download URL: https://sourceforge.net/projects/pizcoin/files/Pizcoin/pizcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PIZ fee schedule (users still pay 0.01 PIZ per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #pizcoin00 - #pizcoin99
