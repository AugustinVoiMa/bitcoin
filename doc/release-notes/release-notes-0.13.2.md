Pizcoin Core version 0.13.2 is now available from:

  <https://pizcoin.org/bin/pizcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update pizcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow pizcoin-tx to create v2 transactions (pizdrak)
