Pizcoin Core version 0.9.4 is now available from:

  https://pizcoin.org/bin/0.9.4/
...
this update is incompatible with the Pizcoin system and could lead to consensus
forks.

Pizcoin Core released binaries from https://pizcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~pizcoin/+archive/ubuntu/pizcoin
- A third-party or self-compiled Pizcoin Core

upgrade to Pizcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
