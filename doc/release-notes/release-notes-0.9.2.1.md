Pizcoin Core version 0.9.2.1 is now available from:

  https://pizcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PIZ to 0.01 PIZ
...
- Fix "Start pizcoin on system login"
