...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PizcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_pizcoin-qt -platform xcb      # Linux
//     src/qt/test/test_pizcoin-qt -platform windows  # Windows
//     src/qt/test/test_pizcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PizcoinUnits::formatWithUnit(unit, balance, false, PizcoinUnits::separatorAlways);
    ...
    // Amount input
    PizcoinAmountField* amountInput = receiveCoinsDialog.findChild<PizcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: pizcoin:")) != -1);
