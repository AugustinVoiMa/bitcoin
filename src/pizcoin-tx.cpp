...
static void SetupPizcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf("%s pizcoin-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  pizcoin-tx [options] <hex-tx> [commands]  Update hex-encoded pizcoin transaction\n" +
              "  pizcoin-tx [options] -create [commands]   Create hex-encoded pizcoin transaction\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pizcoin transaction
