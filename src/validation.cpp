...
#if defined(NDEBUG)
# error "Pizcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Pizcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PIZ additional fees, %d delta bytes\n",
