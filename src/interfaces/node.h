...
#ifndef PIZCOIN_INTERFACES_NODE_H
#define PIZCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a pizcoin node (pizcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // PIZCOIN_INTERFACES_NODE_H
