...
#ifndef PIZCOIN_KEYSTORE_H
#define PIZCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/pizcoin/bips/blob/master/bip-0013.mediawiki
