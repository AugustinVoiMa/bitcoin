...
#ifndef PIZCOIN_TEST_SCRIPTNUM10_H
#define PIZCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pizcoin Core 0.10.0, for cross-comparison.
 */
public:
