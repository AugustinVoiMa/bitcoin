 ...
 */
#ifndef PIZCOIN_UTIL_H
#define PIZCOIN_UTIL_H
...
extern const char * const PIZCOIN_CONF_FILENAME;
extern const char * const PIZCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("pizcoin-%s", name);
