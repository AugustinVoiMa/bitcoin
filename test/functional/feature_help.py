#!/usr/bin/env python3
# Copyright (c) 2018 The Pizcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting pizcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import PizcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PizcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pizcoin with -h for help text")
        ...
        self.log.info("Start pizcoin with -version for version information")
        ...
        self.log.info("Start pizcoind with -fakearg to make sure it does not start")
