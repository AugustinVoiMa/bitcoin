...
# TestP2PConn: A peer we use to send messages to pizcoind, and store responses.
...
class CompactBlocksTest(PizcoinTestFramework):
    ...
    # This test actually causes pizcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that pizcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for pizcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # pizcoind will not send blocktxn responses for blocks whose height is
